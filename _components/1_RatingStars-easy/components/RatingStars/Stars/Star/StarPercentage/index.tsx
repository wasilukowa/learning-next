...
import { StarPercentageProps } from './types';
const { starAverage } = style;

export const StarPercentage = ({ score }: StarPercentageProps) => {
  const percentage = (score - Math.floor(score)) * 100 + '%';
