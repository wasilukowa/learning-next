...
export type TSingleStepReference = React.MutableRefObject<null | HTMLInputElement[]> | undefined;
export type THandleStepNumberChange = (event: React.MouseEvent<HTMLButtonElement, MouseEvent>, direction: AvailabeDirectionTypes) => void;
export type TSubmit = (event: React.MouseEvent<HTMLButtonElement, MouseEvent>) => void;
