...
export const useProgressBar: TUseProgressBar = (currentStep, numberOfSteps) => {
    ...
    useEffect(() => {
        ...
        const isPotentialStepMarkerRefCurrentDefined = potentialStepMarkerRefCurrent !== null;
        ...
        const isPotentialProgressBarRefCurrentDefined = potentialProgressBarRefCurrent !== null;
        ...
        const progressBarMarkerWidth = stepIncreaseWidth * currentStep + progressBarHeight;
